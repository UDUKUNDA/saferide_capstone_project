...
SECRET_KEY = "django-insecure-@8+^j7e*)1k^k1lbs73y@c#ns6@)3#6-1)!nxcreh%2h9s_(dv"
...
# Database
# Use Postgres if environment variables are provided; otherwise fallback to SQLite for local development/presentation
